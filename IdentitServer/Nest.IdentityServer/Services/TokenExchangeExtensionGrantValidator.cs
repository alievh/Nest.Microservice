...
namespace IdentityServer.Services
{
    public class TokenExchangeExtensionGrantValidator : IExtensionGrantValidator
    {
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            {
                context.Result = new GrantValidationResult(IdentityServer4.Models.TokenRequestErrors.InvalidRequest, "Tokken missing");
                return;
            }
            ...
            {
                context.Result = new GrantValidationResult(IdentityServer4.Models.TokenRequestErrors.InvalidRequest, "Tokken invalid");
                return;
            }
            ...
            {
                context.Result = new GrantValidationResult(IdentityServer4.Models.TokenRequestErrors.InvalidRequest, "Tokken must contain 'sub' value");
                return;
            }
